...
func (a CathodicAssessment) Signal(name string) float64 {
	return a.Signals[strings.ToLower(strings.TrimSpace(name))]
}
func (a *CathodicAssessment) AddNote(note string) {
...
func (a CathodicAssessment) RequiresSupervisor() bool {
	r := a.Result()
	return r.Review || r.Band == "high"
}
func (a CathodicAssessment) StableKey() string {
	r := a.Result()
