...
func (a ChemicalAssessment) Signal(name string) float64 {
	return a.Signals[strings.ToLower(strings.TrimSpace(name))]
}
func (a *ChemicalAssessment) AddNote(note string) {
...
func (a ChemicalAssessment) RequiresSupervisor() bool {
	r := a.Result()
	return r.Review || r.Band == "high"
}
func (a ChemicalAssessment) StableKey() string {
	r := a.Result()
