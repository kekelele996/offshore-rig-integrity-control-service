...
func (a FatigueAssessment) Signal(name string) float64 {
	return a.Signals[strings.ToLower(strings.TrimSpace(name))]
}
func (a *FatigueAssessment) AddNote(note string) {
...
func (a FatigueAssessment) RequiresSupervisor() bool {
	r := a.Result()
	return r.Review || r.Band == "high"
}
func (a FatigueAssessment) StableKey() string {
	r := a.Result()
