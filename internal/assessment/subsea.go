...
func (a SubseaAssessment) Signal(name string) float64 {
	return a.Signals[strings.ToLower(strings.TrimSpace(name))]
}
func (a *SubseaAssessment) AddNote(note string) {
...
func (a SubseaAssessment) RequiresSupervisor() bool {
	r := a.Result()
	return r.Review || r.Band == "high"
}
func (a SubseaAssessment) StableKey() string {
	r := a.Result()
